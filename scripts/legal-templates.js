function imprintTemplate() {
    return /*html*/`
        <div class="imprint-privacy-content">
            <h1>Impressum</h1> 
...
function privacyTemplate() {
    return /*html*/`
        <div class="imprint-privacy-content">
            ...
            <h4>Speicherdauer</h4>
            <p>Daten werden in Server-Log-Dateien in einer Form, die die Identifizierung der betroffenen Personen ermöglicht, maximal für 7 Tage gespeichert; es sei denn, dass ein sicherheitsrelevantes Ereignis auftritt (z.B. ein DDoS-Angriff).</p>
